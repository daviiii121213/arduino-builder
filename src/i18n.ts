...
const STRINGS = {
  ...
  practice: ['FREE PRACTICE', 'TREINO LIVRE'],
  practiceShort: ['PRACTICE', 'TREINO'],
  bestLap: ['BEST', 'MELHOR'],
  lastLap: ['LAST', 'ÚLTIMA'],
  noLapYet: ['--:--', '--:--'],
  practiceHint: [
    'The track to yourself: no rivals, no flag, laps timed.',
    'A pista só para você: sem rivais, sem bandeirada, voltas cronometradas.',
  ],
